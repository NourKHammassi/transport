    ...
    >
      <Stack rowGap={"1rem"}>
            ...
            <Stack rowGap={".4rem"}>
              ...
              <Typography color={"text.secondary"} variant="body2">
                {status === "fullfilled"
                  ...
                  : "Entrez votre email enregistré ci-dessous pour recevoir un lien de réinitialisation du mot de passe."}
              </Typography>
            </Stack>
        ...
        <motion.div whileHover={{ x: 2 }} whileTap={{ scale: 1.05 }}>
          ...
          >
            Retour à la{" "}
            <span style={{ color: theme.palette.primary.dark }}>connexion</span>
          </Typography>
        </motion.div>
      </Stack>
    </Stack>
